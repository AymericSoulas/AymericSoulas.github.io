document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            "education-list-3": "Currently in second year of CITISE at Telecom Saint-Etienne (Integrated preparatory class with diploma, notably with a DUT GEII)",
            "skills-title": "Skills",
        ...
        fr: {
            ...
            "education-list-3": "Actuellement en seconde année de CITISE à Télécom Saint-Etienne (Classe préparatoire intégrée diplomante, nottament avec un DUT GEII",
        ...
        es: {
            ...
            "education-list-3": "Actualmente en segundo año de CITISE en Telecom Saint-Etienne (Clase preparatoria integrada con diploma, especialmente con un DUT GEII)",
